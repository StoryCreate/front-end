...
const AudioBooks = () => {
  return (
    <div><h2 className="text-2xl font-semibold mb-4 text-left">Audio Books You Might Like</h2>
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-4">
        <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          />
          <div className="p-4">
            <h3 className="text-lg font-medium text-left">EDUCATED</h3>
            <p className="text-sm text-gray-500 text-left">By Tara Westover</p>
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          />
          <div className="p-4">
            <h3 className="text-lg font-medium text-left">BECOMING</h3>
            <p className="text-sm text-gray-500 text-left">By Michelle Obama</p>
            <div className='flex flex-row justify-between'>
              <div className="flex items-center mt-2 text-gray-500">
                <Eye className="w-4 h-4 mr-1" /> <span className="text-sm">35K</span>
              </div>
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          />
          <div className="p-4">
            <h3 className="text-lg font-medium text-left">THE ALCHEMIST</h3>
            <p className="text-sm text-gray-500 text-left">By Paulo Coelho</p>
            <div className='flex flex-row justify-between'>
              <div className="flex items-center mt-2 text-gray-500">
                <Eye className="w-4 h-4 mr-1" /> <span className="text-sm">35K</span>
              </div>
