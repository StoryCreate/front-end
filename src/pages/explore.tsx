        ...
        <div className="bg-white shadow-inner w-full min-h-[2170px] p-4">
          <div className="flex justify-between items-center h-[49px] mb-8">
            <div className="flex items-center space-x-4 w-[321px]">
              ...
              <div className="text-sm font-semibold text-dark-100 tracking-wide leading-tight">
                Explore
              </div>
            </div>
            <div className="flex items-center space-x-4 w-[321px] justify-end">
              <Users className="w-4 h-4 text-gray-400" />
              <a href="/mycommunity" className="text-gray-400 text-sm text-left font-medium tracking-wide leading-tight hover:text-black">
                My Community
              </a>
            </div>
          </div>
          ...
          <div className="space-y-8">
            {[{
              ...
              {
              title: "Storyteller's Haven",
              description: "A virtual gathering place for storytellers to share their narratives, explore different storytelling techniques, and find encouragement and support from a community of fellow storytellers.",
              imgSrc: "https://c.animaapp.com/D8UwJhxt/img/ellipse-1975-5@2x.png",
              link: "/community"
            },
              {
