          ...
          <div className="group">
            <div>
              <div>
                ...
                <button id="search" > Search </button> <i className='bx bxs-bell' id="bell"> </i> <i className='bx bx-chat' id="chat"></i> <i className='bx bx-group' id="group"> </i> </div>
              </div>
            </div>
        </div>
          ...
          <div className="frame">
            <div className="group-4">
              ...
              <div className="group-6">
                ...
                <div> <p className="p">I came across this amazing library. Y’all should check it out</p> </div>
              ...
              <div>
                ...
                <div> <p className="p2">Me and mines!!! Do y’all agree fashion is art?</p> </div>
              ...
              <div className="group-13">
                ...
                <p className="p4">This is definitely one of the best books of our time!</p>
              ...
              <div className="group-16">
                ...
                <p className="p5">Anime is everything it thinks it is! Damn!!</p>
