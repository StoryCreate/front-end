        ...
        <div className="overlap">
          ...
          <div className="group-2">
            <div className="overlap-2">
              <div>
              <input type="text" className="text-wrapper-3" placeholder="Type anything..." />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="available-group">
            <img className="gig-line" alt="gigs-Line" src={line} />
              <div className="group-3">
                <a href="/findgig"> <div className="available-jobs-2">Available jobs</div> </a>
              </div>
        </div>

        <div className="saved-group">
                <div className="saved-jobs-2">Saved jobs</div>
        </div>
